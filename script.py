...
""" The Google Drive file ID for the Pitt Cookie Theft Corpus data is stored
as a Colab secret (key: GDRIVE_FILE_ID) and is not included in this notebook
for data sharing compliance reasons. To run this notebook, add the file ID
as a Colab secret via the key icon in the left sidebar, or contact the
author for access to the data. """
from google.colab import userdata
file_id = userdata.get('GDRIVE_FILE_ID')
